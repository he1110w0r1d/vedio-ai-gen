...
export function Providers() {
  ...
  return (
    <div>
      ...
      <div className="mb-5 rounded-2xl border border-primary-fixed-dim/30 bg-primary-fixed-dim/10 p-4 text-sm text-primary">
        调用费用由用户自己的供应商账户承担，实际扣费和审核规则以对应供应商为准。请不要在代码中写入真实 API Key。
      </div>
